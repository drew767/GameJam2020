...
public class WeaponInventory : MonoBehaviour {
	...
	*/
	...
	public SelectionMenuStyle selectionMenuStyle = SelectionMenuStyle.horizontal;
	...
	void DrawCorrespondingImage(int _number){
		...
		if(selectionMenuStyle == SelectionMenuStyle.horizontal){
		...
		else if(selectionMenuStyle == SelectionMenuStyle.vertical){
			if(deleteCloneFromName == gunsIHave[_number]){
